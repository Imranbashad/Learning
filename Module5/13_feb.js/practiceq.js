const input = parseInt(prompt(),10)     //10 is give decimal value and is default paramter of prompt , 2 gives binary
// leanr about logarithams
function userAge (input) {
    return new Promise((resolve,reject) =>{
        let users = [
            {user1 : "nemesis",age : 23},
            {user1 : "nemesis",age : 45},
            {user1 : "nemesis",age : 19},
            {user1 : "nemesis",age : 100}
        ]
        const filterUsers = users.filter( user => user.age > input)
